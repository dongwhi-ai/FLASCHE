...
class Model02():
    ...
    def __init__(self, label_num, input_shape):
        ...
        self.dummy_filters = [Filter() for _ in range(label_num)]
...
def save_top_filter_count(model: Model02, save_dir, one_file):
...
def save_trained_count(model: Model02, save_dir, one_file):
...
def save_trained_count_sep(model: Model02, save_dir, top):
    print("saving trained ctcam counts...")
    for j in range(top):
...
# def save_trained_count_sep_72bits(model: Model02, save_dir, top):
#     print("saving trained ctcam counts...")
#     for j in range(top):
#         file_path = save_dir+f"/top{j+1}.txt"
#         with open(file_path,'w') as f:
